class collector2 {
    ...
    updateState() {
        if (keyIsDown(37)) { //if key is held do the following
            this.phase = "walkL";
            this.a -= 10;
        ...
        if (keyIsDown(39)) { //if key is held do the following
            this.phase = "walkR";
            this.a += 10;
        ...
        if (keyIsDown(40)) { //if key is held do the following
            this.phase = "Down";
            this.b += 10;
        } else if (this.phase === "Down") {
            this.phase = "faceDown"; //else change to just facing a side
        }
        if (keyIsDown(38)) { //if key is held do the following
            this.phase = "Up";
            this.b -= 10;
